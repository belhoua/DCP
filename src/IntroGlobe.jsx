...
const EARTH_TEXTURES = {
  ...
  night: `${BASE}textures/earth_lights.jpg`,    // city lights (night side)
...
export default function IntroGlobe({ onComplete }) {
  ...
  useEffect(() => {
    ...
    // Remove the instant HTML preloader once we're ready to show the scene
    const hidePreloader = () => {
    ...
    renderer.setPixelRatio(Math.min(window.devicePixelRatio, isMobileDevice ? 1.25 : 1.5))
